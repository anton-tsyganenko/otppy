...
* Программа не предназначена для шифрования больших файлов, но небольшие файлы (несколько мегабайт) можно шифровать спокойно. Шифрование более крупных файлов может занять некоторое время. **Следите, чтобы суммарный размер файла и ключа был меньше свободной оперативной памяти**

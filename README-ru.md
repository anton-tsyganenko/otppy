...
`-z action`, `--gzip=action` - `compress` - сжать или `decompress` - восстановить данные с помощью gzip. `no` - не использовать (по умолчанию).  
...
* Сжатие может уменьшать объем текстовых данных в несколько раз, но если вы хотите его использовать, заранее договоритесь со своим собеседником.
